...
for(let i = 1; i <= guestsAmount; i++) {
    ...
    <div class="input-container relative w-80">
        <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-800 outline-none" type="text" name="" required>
