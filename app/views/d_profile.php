    ...
    <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto transition-transform duration-200 -translate-x-full bg-zinc-100 border-0 shadow-xl dark:shadow-none dark:bg-zinc-700 max-w-64 ease z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-zinc-100 dark:opacity-80 py-2.5 text-sm ease my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg transition-colors hover:bg-white hover:dark:shadow-white hover:dark:bg-black hover:shadow" href="d-booking.html">
                        <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-zinc-100 dark:opacity-80 py-2.5 text-sm ease my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg transition-colors hover:bg-white hover:dark:shadow-white hover:dark:bg-black hover:shadow" href="d-manage.html">
                        <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-zinc-100 dark:opacity-80 py-2.5 text-sm ease my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg transition-colors hover:bg-white hover:dark:shadow-white hover:dark:bg-black hover:shadow" href="d-active.html">
                        <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-zinc-100 dark:opacity-80 py-2.5 text-sm ease my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg transition-colors hover:bg-white hover:dark:shadow-white hover:dark:bg-black hover:shadow" href="d-canceled.html">
                        <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 text-2xl font-bold text-emerald-500">-10%</h5>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 text-2xl font-bold text-emerald-500">45</h5>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="flex-none w-auto max-w-full px-3">
                                <div class="relative inline-flex items-center justify-center text-white transition-all duration-200 ease-in-out text-base h-19 w-19 rounded-xl">
                                    <img src="img/user_image.jpg" alt="profile_image" class="w-full shadow-xl rounded-xl">
                                </div>
                            </div>
                            <div class="flex-none w-auto max-w-full px-3 my-auto">
                                <div class="h-full">
                                    <p class="font-semibold text-lg md:text-2xl leading-normal dark:text-white dark:opacity-60">Full name of the user</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="username" value="lucky.jesse" class="focus:shadow-primary-outline dark:bg-zinc-800 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" readonly>
                                </div>
                            </div>
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="email" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Email address</label>
                                    <input type="email" name="email" value="jesse@example.com" class="focus:shadow-primary-outline dark:bg-zinc-800 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" readonly>
                                </div>
                            </div>
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="first name" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">First name</label>
                                    <input type="text" name="first name" value="Jesse" class="focus:shadow-primary-outline dark:bg-zinc-800 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" readonly>
                                </div>
                            </div>
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="family name" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Family name</label>
                                    <input type="text" name="family name" value="Lucky" class="focus:shadow-primary-outline dark:bg-zinc-800 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" readonly>
                                </div>
                            </div>
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="phone" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Phone number</label>
                                    <input type="number" name="phone" value="04523423423" class="focus:shadow-primary-outline dark:bg-zinc-800 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full max-w-full px-3 mt-0 shrink-0 lg:w-1/2 lg:flex-none">
                            <ul class="flex flex-wrap justify-center pl-0 mb-0 list-none lg:justify-end">
                                <li class="nav-item ps">
                                    <a href="index.html" class="block px-4 pt-0 pb-1 text-sm font-normal transition-colors ease-in-out text-zinc-500">Home</a>
                                </li>
                                <li class="nav-item">
...
<!-- plugin for charts  -->
<script src="js/js/plugins/chartjs.min.js" async></script>
<!-- main script file  -->
<script src="js/js/argon-dashboard-tailwind.js?v=1.0.1" async></script>
</html>
