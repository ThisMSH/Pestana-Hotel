                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <?php if(!empty($reserv['Check_In']) && ($reserv['Check_In'] > date('Y-m-d'))) { ?>
                                                ...
                                                <div class="cancel-popup fixed hidden top-1/2 left-1/2 w-[500px] max-w-[94%] h-72 bg-slate-100 text-slate-900 rounded-xl px-3 py-8 -translate-x-1/2 -translate-y-1/2 z-[999] border drop-shadow">
