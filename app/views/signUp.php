        ...
        <div class="relative lg:w-2/3 lg:h-[38vw] lg:min-h-[60%] lg:top-[48%] lg:left-[35%] lg:-translate-x-1/2 lg:-translate-y-1/2">
            <form action="signing_up" method="post" class="flex flex-col items-center justify-around h-full">
                <div class="flex flex-wrap justify-around items-center w-full">
                    <svg class="w-1/5 min-w-[200px] min-h-[175px] fill-white" version="1.1" id="layer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="guide w-80 h-40 2xl:w-96">
                        <p class="block text-center font-semibold text-2xl">Create <span class="text-amber-400">Your Account</span></p>
                        <p class="hidden">Your <span class="text-amber-400">first name</span> must be between 3 and 32 characters, and can contains only letters and 1 white space at max.</p>
                        <p class="hidden">Your <span class="text-amber-400">family name</span> must be between 3 and 32 characters, and can contains only letters and 2 white spaces at max.</p>
                        <p class="hidden">Please enter your <span class="text-amber-400">birthday</span> or you can use a calendar using the calendar icon.</p>
                        <p class="hidden">Please enter your <span class="text-amber-400">phone number</span>.</p>
                        <p class="hidden">Your <span class="text-amber-400">username</span> must be between 5 and 16 characters, and can contains only alphanumerics.</p>
                        <p class="hidden">Please enter your <span class="text-amber-400">E-mail</span>.</p>
                        <p class="hidden">Your <span class="text-amber-400">password</span> must be between 8 and 36 characters, and must contain at least one lowercase and uppercase character, a number and a special character [! @ # $ % ^ & *].</p>
                        <p class="hidden">Please re-enter your <span class="text-amber-400">password</span>.</p>
                    </div>
                </div>
                <div class="flex gap-x-20 gap-y-3 flex-wrap lg:flex-nowrap justify-center mb-10 lg:mb-0">
                    <div class="flex flex-col gap-3 md:gap-4">
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="text" name="firstname" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">First name</span>
                        </div>
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="text" name="familyname" required>
                        ...
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-900 bg-zinc-900 outline-none transition duration-300 focus:text-zinc-100 valid:text-zinc-100" type="date" name="bday" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">Birthday</span>
                        </div>
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="tel" name="phone" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">Phone number</span>
                        </div>
                    </div>
                    <div class="flex flex-col gap-3 md:gap-4">
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="text" name="username" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">Username</span>
                        </div>
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="text" name="email" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">E-mail</span>
                        </div>
                        <div class="input-container relative w-80">
                        ...
                        <div class="input-container relative w-80">
                            <input class="w-full p-4 border border-solid border-zinc-100 rounded-lg text-zinc-100 bg-zinc-900 outline-none" type="password" name="conpassword" required>
                            <span class="absolute left-0 p-4 pointer-events-none text-zinc-100 transition-all duration-300 ease-in-out">Confirm your password</span>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap flex-row-reverse justify-evenly items-center w-full mb-10 sm:mb-0">
                    <button class="group relative overflow-hidden px-14 py-4 mb-4 sm:mb-0 border-2 border-zinc-100 rounded-full text-xl before:absolute before:left-0 before:top-0 before:w-1/2 before:h-full before:bg-gradient-to-l before:from-zinc-100-0.4 before:skew-x-[45deg] before:transition-all before:duration-500 hover:before:left-44" type="submit" name="submit"><p class="transition-all duration-500 ease-in-out group-hover:scale-125">Sign Up</p></button>
                    <p class="shadow-md">You already have an account? <a href="<?= URLROOT . "signin/login" ?>" class="underline decoration-amber-400 decoration-2 underline-offset-2">Sign in now!</a></p>
                </div>
            </form>
        </div>
    </div>
