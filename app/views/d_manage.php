...
<html>
  <head>
    ...
    <title>Pestana Dashboard - Rooms Management</title>
  </head>
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-zinc-600 before:float-left before:pr-2 before:text-zinc-600 before:content-['/']" aria-current="page">Rooms Management</li>
                    </ol>
                </nav>
                    ...
                    <div class="overflow-x-auto scroll-bar">
                      <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                        <thead class="align-bottom">
                            <tr>
                                <th class="px-6 py-3 pl-2 font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-zinc-700 opacity-80">Thumbnail</th>
                                ...
                                <th class="px-6 py-3 pl-2 font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-zinc-700 opacity-80">Room Gap</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <div class="px-2 py-1">
                                        <img class="w-40 min-w-[120px]" src="img/suite/1.jpg" alt="" srcset="">
                                    </div>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">Room Name</p>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">Room Type</p>
                                </td>
                                <td class="p-2 text-sm leading-normal align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">6</p>
                                </td>
                                <td class="p-2 text-sm leading-normal align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">234 €</p>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                            ...
                            <tr>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <div class="px-2 py-1">
                                        <img class="w-40 min-w-[120px]" src="img/suite/3.jpg" alt="" srcset="">
                                    </div>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">Room Name</p>
                            ...
                            <tr>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <div class="px-2 py-1">
                                        <img class="w-40 min-w-[120px]" src="img/suite/5.jpg" alt="" srcset="">
                                    </div>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-t dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <p class="text-sm font-semibold leading-tight dark:text-white dark:opacity-80">Room Name</p>
