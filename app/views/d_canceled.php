...
<html>
  <head>
    ...
    <title>Pestana Dashboard - Canceled Bookings</title>
  </head>
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col">
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-zinc-100 dark:opacity-80 py-2.5 text-sm ease my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg transition-colors hover:bg-white hover:dark:shadow-white hover:dark:bg-black hover:shadow" href="d-profile.html">
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-zinc-600 before:float-left before:pr-2 before:text-zinc-600 before:content-['/']" aria-current="page">Canceled Bookings</li>
                    </ol>
                </nav>
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div class="inline-flex justify-center items-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-blue-700 to-violet-300">
                                        <i class="material-icons leading-none relative text-white">analytics</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-zinc-800 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div class="inline-flex justify-center items-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-green-700 to-emerald-300">
                                        <i class="material-icons leading-none relative text-white">room_service</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-zinc-800 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div class="inline-flex justify-center items-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-red-700 to-orange-300">
                                        <i class="material-icons leading-none relative text-white">event_busy</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-zinc-800 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div class="inline-flex justify-center items-center w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-zinc-700 to-slate-300">
                                        <i class="material-icons leading-none relative text-white">people</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                      ...
                      <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <span class="bg-gradient-to-tl from-red-600 to-orange-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Canceled</span>
                                </td>
                            </tr>
                        </tbody>
                      </table>
